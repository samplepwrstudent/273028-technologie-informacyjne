...
\addplot [line width=2mm, color=red] table [/pgf/number format/read comma as period, header=false,x index=0,y index=1, mark=none, col sep=semicolon] {dane_lab.csv};
